...
class SurrogateModel:
    ...
    def _get_phenotype(self, platform_params):
        ...
        with warnings.catch_warnings():
            ...
            surge_vector = np.nan_to_num(np.array(surge_vector, dtype=float),
                                         nan=CONFIG['MIN_SURGE'], posinf=CONFIG['MAX_SURGE'], neginf=CONFIG['MIN_SURGE'])
            subsidy_vector = np.nan_to_num(np.array(subsidy_vector, dtype=float),
                                           nan=CONFIG['MIN_SUBSIDY'], posinf=CONFIG['MAX_SUBSIDY'], neginf=CONFIG['MIN_SUBSIDY'])
