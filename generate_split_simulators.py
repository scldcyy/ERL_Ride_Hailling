...
# 导入您指定的 generate_simulator.py 中的类
...
def main():
    ...
    # 确保时间列是 datetime 类型 (generate_simulator.py 中可能还没转)
    ...
    for dtype in day_types:
        ...
        # 实例化 PassengerSimulator (使用 generate_simulator.py 中的类)
        ...
        # 保存
        filename = f"simulator_hex_scaling={scaling_factor}_{dtype.lower()}.pkl"
